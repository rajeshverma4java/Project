...
public class UomUtil {
	...
	public void generatePie(String path,List<Object[]> data) {
		...
		try {
			ChartUtils.saveChartAsJPEG(new File(path+"resources/images/UomTypeA.jpg"), chart, 400, 400);
	...
	public void generateBarChart(String path,List<Object[]> data) {
		...
		JFreeChart chart=ChartFactory.createBarChart("UomType", "Modes", "Count", dataset);
		
		//save image
		
		try {
			ChartUtils.saveChartAsJPEG(new File(path+"resources/images/UomTypeB.jpg"), chart, 400, 400);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
